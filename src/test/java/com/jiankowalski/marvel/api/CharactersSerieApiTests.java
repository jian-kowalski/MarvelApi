...
public class CharactersSerieApiTests {
	...
	void setUp() {
		...
		RestAssured.basePath = "/v1/public/characters/{characterId}/series";
	}

	@Test
    public void deveRetornarStatus200_QuandoConsultaSerieCharactersExistente() {
        RestAssured.given()
	...
	@Test
    public void deveRetornarStatus404_QuandoConsultaSerieCharactersInexistente() {
        RestAssured.given()
